// Code generated by 'mjson2go -out=front_of_card.go front_of_card.json' DO NOT EDIT.
...
func GetFront_of_card(deckID string, cardID string, username string) mongo.Pipeline {
