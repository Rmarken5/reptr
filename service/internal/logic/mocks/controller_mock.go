...
// Source: github.com/rmarken/reptr/service/internal/logic (interfaces: Controller)
//
...
func (m *MockController) CreateGroup(arg0 context.Context, arg1 models.Group) (string, error) {
	m.ctrl.T.Helper()
